...
const DashboardMain: React.FC<MainProps> = ({ children }) => {
  return (
    ...
    <div className="flex min-h-[calc(100vh-60px)] min-w-full flex-col pl-0 pt-[60px] lg:pl-[245px] lg:pt-[15px]">
      <div className="absolute flex w-full flex-grow justify-center overflow-hidden lg:justify-start lg:px-[15px]">
        <div className="dashboard-main-box mx-[15px] h-full w-full overflow-y-auto rounded-xl bg-gray-100 p-[12px] lg:fixed lg:mx-0 lg:h-[calc(100%-60px)] lg:w-[calc(100%-275px)]">
          {children}
        </div>
      </div>
    </div>
